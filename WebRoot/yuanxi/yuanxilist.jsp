...
<a href="${url2 }add"><span style="font-size: 15px;font-weight: bold;color: red;">添加新院系</span></a>
&nbsp;&nbsp;&nbsp;
院系名：<input name="yname" type="text"  value="${yname }">
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td>
	<a href="method!zhuanyelist?yid=${bean.id }">专业列表</a>|
