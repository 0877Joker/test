...
<a href="${url2 }add5"><span style="font-size: 15px;font-weight: bold;color: red;">导入考生信息</span></a>
&nbsp;&nbsp;&nbsp;
<a href="method!userlist6"><span style="font-size: 15px;font-weight: bold;color: red;">导出考生信息</span></a>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td>
  	<a href="${url2 }update7?id=${bean.id }">更新</a> |
  	<a href="${url2 }delete7?id=${bean.id }" onclick="return confirm('真的要删除吗?');">删除</a>
	</td>
</tr>
</c:forEach>
